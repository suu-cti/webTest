...
async function handleModules(courseID){
...
async function getFilesFromCourse(url, previousResponse){
    files = new Array()
...
async function getPreliminaryContentFromPage(pageType, url, previousResponse){
...
async function getContentFromPage(location, url, courseID){
    //Calls API using url
...
function getHTMLFromContent(content, location, url, courseID){
...
function removeExtraLinkContent(url, courseID){
...
function getLinksFromHTML(content, pageURL){
    if(content != null){
...
function getFileNamesFromLinks(content, position, idLocation, pageURL){
...
function getFileIDFromName(link, idLocation){
...
function compareAllFilesToFilesUsed(){
...
function csvContentFromData(index){
