...
class TutoringButtons{
    ...
    constructor(){
        ...
        if(this.classDictionary[title]){
            ...
            for(var i = 0; i < this.classDictionary[title].length; i++){
                $('#'+this.tutoringID).append('<a class="Button Button--primary Button--block" style = "margin-bottom: 0.5%; width: 90%; margin-left: auto; margin-right: auto;" href="'+ this.classDictionary[title][i][0] +'" >' + classDictionary[title][i][1] + ' </a>')
            }
        }
    }
}
