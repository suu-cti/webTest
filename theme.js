...
console.log("Script manager working")
var scripts = [ 'assignment_switcher.js', 'buttons.js', 'hide_elements.js', 'hide_inactives.js', 'knowledge_checks.js', 'show_file_use.js', 'third_party_scripts.js', 'tutoring_buttons.js']
for(var i = 0; i < scripts.length; i++){
	var script = document.createElement("script");
	script.src = 'https://cdn.jsdelivr.net/gh/suu-otl/webTest@cc6cbfc39c4c9a3fa6797a0d1fa5082f7627b40b/' + scripts[i];
	document.head.appendChild(script);
}
